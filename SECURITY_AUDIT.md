...
### Scope & Primary Goals
* **Scope:** Internal IT audit assessment covering user permissions, existing controls/procedures, and hardware/software assets in use [cite: 5].
* **Goals:** Align operations with the NIST Cybersecurity Framework, improve regulatory compliance, and strengthen system controls [cite: 5].
